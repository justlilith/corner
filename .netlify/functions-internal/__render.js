...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/_app/start-054b1cc0.js",
      css: [assets + "/_app/assets/start-61d1577b.css"],
      js: [assets + "/_app/start-054b1cc0.js", assets + "/_app/chunks/vendor-f9401e75.js"]
    },
    fetched: void 0,
    floc: false,
...
var metadata_lookup = { "src/routes/__layout.svelte": { "entry": "pages/__layout.svelte-d5a2d08f.js", "css": ["assets/pages/__layout.svelte-02730435.css"], "js": ["pages/__layout.svelte-d5a2d08f.js", "chunks/vendor-f9401e75.js", "chunks/helpers-edd2a2c9.js"], "styles": [] }, ".svelte-kit/build/components/error.svelte": { "entry": "error.svelte-f5f70058.js", "css": [], "js": ["error.svelte-f5f70058.js", "chunks/vendor-f9401e75.js"], "styles": [] }, "src/routes/index.svelte": { "entry": "pages/index.svelte-43e976cd.js", "css": ["assets/pages/index.svelte-50ee9d5f.css"], "js": ["pages/index.svelte-43e976cd.js", "chunks/vendor-f9401e75.js"], "styles": [] }, "src/routes/articles/index.svelte": { "entry": "pages/articles/index.svelte-da735d6a.js", "css": [], "js": ["pages/articles/index.svelte-da735d6a.js", "chunks/vendor-f9401e75.js"], "styles": [] }, "src/routes/articles/fsharp-advent-api.svelte": { "entry": "pages/articles/fsharp-advent-api.svelte-a3902fc1.js", "css": ["assets/pages/articles/fsharp-advent-api.svelte-4e968c0f.css"], "js": ["pages/articles/fsharp-advent-api.svelte-a3902fc1.js", "chunks/vendor-f9401e75.js"], "styles": [] }, "src/routes/template.svelte": { "entry": "pages/template.svelte-d85fc384.js", "css": [], "js": ["pages/template.svelte-d85fc384.js", "chunks/vendor-f9401e75.js"], "styles": [] }, "src/routes/spells.svelte": { "entry": "pages/spells.svelte-c112ab40.js", "css": [], "js": ["pages/spells.svelte-c112ab40.js", "chunks/vendor-f9401e75.js"], "styles": [] }, "src/routes/notes.svelte": { "entry": "pages/notes.svelte-df49fa66.js", "css": ["assets/pages/notes.svelte-4e26c676.css"], "js": ["pages/notes.svelte-df49fa66.js", "chunks/vendor-f9401e75.js"], "styles": [] }, "src/routes/back.svelte": { "entry": "pages/back.svelte-cf04ef2a.js", "css": [], "js": ["pages/back.svelte-cf04ef2a.js", "chunks/vendor-f9401e75.js"], "styles": [] }, "src/routes/test.svelte": { "entry": "pages/test.svelte-cea23b7e.js", "css": [], "js": ["pages/test.svelte-cea23b7e.js", "chunks/vendor-f9401e75.js"], "styles": [] }, "src/routes/work.svelte": { "entry": "pages/work.svelte-8aee860c.js", "css": ["assets/pages/work.svelte-f5af36d0.css"], "js": ["pages/work.svelte-8aee860c.js", "chunks/vendor-f9401e75.js", "chunks/helpers-edd2a2c9.js"], "styles": [] } };
...
<div><!-- HTML_TAG_START -->${(0, import_marked.default)(`Sometimes I write articles. Here is the current list:`)}<!-- HTML_TAG_END -->
  
  <!-- HTML_TAG_START -->${(0, import_marked.default)(`- [Fedis](https://justlilith.com/articles/fsharp-advent-api)`)}<!-- HTML_TAG_END -->
...
<div><!-- HTML_TAG_START -->${(0, import_marked.default)(`So, you wanna learn F Sharp? And you wanna do so by building a key-value store, served via a .NET 6.0 minimal API? Then this is the perfect post for you ^_^`)}<!-- HTML_TAG_END -->
  ...
  <!-- HTML_TAG_START -->${(0, import_marked.default)(`Line 5 is an example of an attribute. [A lot has been written elsewhere](https://docs.microsoft.com/en-us/dotnet/fsharp/language-reference/attributes) about attributes, but the short version is that attributes give the compiler some extra information about what you're doing. In this example, we have the \`[<EntryPoint>]\` attribute, which tells the compiler where to start executing code when the program is run.`)}<!-- HTML_TAG_END -->
    ...
    <div class="${"smallcode svelte-t2x2ih"}"><!-- HTML_TAG_START -->${(0, import_marked.default)(`\`\`\` 
open System
open Microsoft.AspNetCore.Builder
open Microsoft.Extensions.Hosting
open Microsoft.Extensions.Logging
...
var css$1 = {
  code: ".scroll-notifier-wrapper.svelte-1taxf02.svelte-1taxf02{color:#fff;background-color:rgba(0, 0, 0, 0.5);margin:auto;padding:0.5em;position:absolute;text-align:center;width:100%}.scroll-notifier.svelte-1taxf02.svelte-1taxf02{display:inline-block}.scroll-notifier.svelte-1taxf02 span.svelte-1taxf02{display:inline-block;vertical-align:middle;user-select:none}",
  map: `{"version":3,"file":"ScrollNotifier.svelte","sources":["ScrollNotifier.svelte"],"sourcesContent":["<script lang='ts'>import { onMount } from 'svelte';\\r\\nimport '$lib/ts/helpers';\\r\\nonMount(() => {\\r\\n});\\r\\n<\/script>\\n\\n<div class='scroll-notifier-wrapper'>\\n  <div class='scroll-notifier'>\\n    <span class=\\"material-icons-outlined\\">expand_more</span>\\n    <span>Scroll Down</span>\\n  </div>\\n</div>\\n\\n<style lang='scss'>.scroll-notifier-wrapper {\\n  color: #fff;\\n  background-color: rgba(0, 0, 0, 0.5);\\n  margin: auto;\\n  padding: 0.5em;\\n  position: absolute;\\n  text-align: center;\\n  width: 100%;\\n}\\n\\n.scroll-notifier {\\n  display: inline-block;\\n}\\n.scroll-notifier span {\\n  display: inline-block;\\n  vertical-align: middle;\\n  user-select: none;\\n}</style>"],"names":[],"mappings":"AAamB,wBAAwB,8BAAC,CAAC,AAC3C,KAAK,CAAE,IAAI,CACX,gBAAgB,CAAE,KAAK,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,CACpC,MAAM,CAAE,IAAI,CACZ,OAAO,CAAE,KAAK,CACd,QAAQ,CAAE,QAAQ,CAClB,UAAU,CAAE,MAAM,CAClB,KAAK,CAAE,IAAI,AACb,CAAC,AAED,gBAAgB,8BAAC,CAAC,AAChB,OAAO,CAAE,YAAY,AACvB,CAAC,AACD,+BAAgB,CAAC,IAAI,eAAC,CAAC,AACrB,OAAO,CAAE,YAAY,CACrB,cAAc,CAAE,MAAM,CACtB,WAAW,CAAE,IAAI,AACnB,CAAC"}`
};
var ScrollNotifier = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css$1);
  return `<div class="${"scroll-notifier-wrapper svelte-1taxf02"}"><div class="${"scroll-notifier svelte-1taxf02"}"><span class="${"material-icons-outlined svelte-1taxf02"}">expand_more</span>
    <span class="${"svelte-1taxf02"}">Scroll Down</span></div>
</div>`;
});
var css = {
  code: ".work-images.svelte-169vu1c{height:50vh;overflow-y:scroll;scrollbar-width:none;position:relative}img.svelte-169vu1c{width:100%;margin-bottom:5px}.work.svelte-169vu1c{padding-bottom:100px;border-bottom:thin solid #666}.work.svelte-169vu1c:last-of-type{padding-bottom:100px;border-bottom:none}",
  map: `{"version":3,"file":"Work.svelte","sources":["Work.svelte"],"sourcesContent":["<script lang='ts'>import marked from 'marked';\\r\\nimport { onMount } from 'svelte';\\r\\nimport * as Helpers from '$lib/ts/helpers';\\r\\nimport ScrollNotifier from '$lib/components/ScrollNotifier.svelte';\\r\\nonMount(() => {\\r\\n    Helpers.addRainbowBackground('work-images');\\r\\n});\\r\\nexport let work;\\r\\n<\/script>\\n\\n<div class='work'>\\n  <!-- <h3>{work.title}</h3> -->\\n  {@html marked(work.description)}\\n  {#if work[\\"imageURLs\\"].length > 1}\\n  <div class='work-images'>\\n    <ScrollNotifier></ScrollNotifier>\\n    {#each work[\\"imageURLs\\"] as url}\\n    <img src={url} alt={work.title}/>\\n    {/each}\\n  </div>\\n  {:else}\\n  <img class='work-image' src={work[\\"imageURLs\\"][0]} alt={work.title}/>\\n  {/if}\\n</div>\\n\\n<style lang='scss'>.work-images {\\n  height: 50vh;\\n  overflow-y: scroll;\\n  scrollbar-width: none;\\n  position: relative;\\n}\\n\\nimg {\\n  width: 100%;\\n  margin-bottom: 5px;\\n}\\n\\n.work {\\n  padding-bottom: 100px;\\n  border-bottom: thin solid #666;\\n}\\n\\n.work:last-of-type {\\n  padding-bottom: 100px;\\n  border-bottom: none;\\n}</style>"],"names":[],"mappings":"AAyBmB,YAAY,eAAC,CAAC,AAC/B,MAAM,CAAE,IAAI,CACZ,UAAU,CAAE,MAAM,CAClB,eAAe,CAAE,IAAI,CACrB,QAAQ,CAAE,QAAQ,AACpB,CAAC,AAED,GAAG,eAAC,CAAC,AACH,KAAK,CAAE,IAAI,CACX,aAAa,CAAE,GAAG,AACpB,CAAC,AAED,KAAK,eAAC,CAAC,AACL,cAAc,CAAE,KAAK,CACrB,aAAa,CAAE,IAAI,CAAC,KAAK,CAAC,IAAI,AAChC,CAAC,AAED,oBAAK,aAAa,AAAC,CAAC,AAClB,cAAc,CAAE,KAAK,CACrB,aAAa,CAAE,IAAI,AACrB,CAAC"}`
};
var Work = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.work === void 0 && $$bindings.work && work2 !== void 0)
    $$bindings.work(work2);
  $$result.css.add(css);
  return `<div class="${"work svelte-169vu1c"}">
  <!-- HTML_TAG_START -->${(0, import_marked.default)(work2.description)}<!-- HTML_TAG_END -->
  ${work2["imageURLs"].length > 1 ? `<div class="${"work-images svelte-169vu1c"}">${validate_component(ScrollNotifier, "ScrollNotifier").$$render($$result, {}, {}, {})}
    ${each(work2["imageURLs"], (url) => `<img${add_attribute("src", url, 0)}${add_attribute("alt", work2.title, 0)} class="${"svelte-169vu1c"}">`)}</div>` : `<img class="${"work-image svelte-169vu1c"}"${add_attribute("src", work2["imageURLs"][0], 0)}${add_attribute("alt", work2.title, 0)}>`}
</div>`;
});
